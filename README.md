...
* <span id="head-VLP"> **💬 Vision and language Pre-training (VLP)**  </span>
    * ⭐⭐(arXiv preprint 2022) **Image as a Foreign Language: BEiT Pretraining for All Vision and Vision-Language Tasks**, Wenhui Wang et al. [[Paper](https://arxiv.org/abs/2208.10442)] 
      ...
      * 📚 【Visual-Language】Visual Question Answering (VQA), Visual Reasoning, Image Captioning, Image-Text Retrieval 【Visual】Object Detection, nstance Segmentation, Semantic Segmentation, Image Classification
